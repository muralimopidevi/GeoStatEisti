"""
Django settings for GeoStatEisti project.
...
SECRET_KEY = '^p+ij#vwu7@yitom9y2$rrh!kfsjc@v^aww6!-bgb+bbfrvgj='
...
ROOT_URLCONF = 'GeoStatEisti.urls'
...
WSGI_APPLICATION = 'GeoStatEisti.wsgi.application'
